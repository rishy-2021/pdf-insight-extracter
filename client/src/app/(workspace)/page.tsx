      ...
      <div className="w-full max-w-xl rounded-md p-6">
        <form onSubmit={handleSubmit}>
          ...
          <div className="mt-4 text-sm font-semibold text-[#1C17FF] p-2 mb-5 rounded-lg">
            <p>
              Add file to extract details.
              <br />
              Please make sure file is not more than 5MB each.
            </p>
          </div>
          <button
            type="submit"
            ...
            disabled={isLoading}
          >
            {isLoading ? <Spinner /> : "Create New Workspace"}
          </button>
          {isLoading && (
            <div className="mt-4 text-sm font-bold text-gray-600">
              Upserting and indexing documents... This may take a few
              minutes....
            </div>
          )}
        </form>
